...
class Converter {
    ...
    convertElement = (elementName, parentPath, element) => {
    ...
    convertBoundAction = (entityName, actionName, action) => {
    ...
    convertParameter = (paramName, parentPath, parameter) => {
        if (parameter) {
    ...
    convertBindingParameter = (action, bindingEntity, parentPath) => {
    ...
    convertReturnParameter = (action, parentPath) => {
    ...
    convertDraftPropertyNode = (xsnObject, propName, propertyType, parentPath) => {
    ...
    convertEntitySetNode = (entitySetName, parentPath, entity) => {
    ...
    convertActionFunctionImportNode = (actionFunctionName, parentPath, actionOrFunctionFqName, actionOrFunction) => {

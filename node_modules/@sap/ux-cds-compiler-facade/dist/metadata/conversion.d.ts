import type { ICdsCompiler, XsnArtifact, XsnElement, XsnFinalEffectiveType, XsnNamedObject, XsnObject, XsnOriginatedObject, XsnDependency, XsnUsing, XsnNamespace, XsnEnum } from '@sap/cds-compiler-types';
import type { EnumValue, MetadataElement } from '@sap-ux/odata-annotation-core-types';
...
export declare class Converter {
    ...
    convertEnums(enums: Record<string, XsnEnum>): EnumValue[];
    convertLiteral(literalNode: XsnEnum['value']): unknown;
    ...
    convertDraftPropertyNode: (xsnObject: XsnOriginatedObject, propName: string, propertyType: string, parentPath: string | undefined) => MetadataElement;

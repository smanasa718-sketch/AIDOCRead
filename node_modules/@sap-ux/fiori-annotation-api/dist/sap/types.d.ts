...
export declare const UI_FIELD_GROUP = "UI.FieldGroup";
...
export declare const UI_FACETS = "UI.Facets";
...
export declare const UI_REFERENCE_FACET = "UI.ReferenceFacet";

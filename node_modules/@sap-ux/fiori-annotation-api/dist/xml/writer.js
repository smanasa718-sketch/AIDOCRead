...
class XMLWriter {
    ...
    getTextEditsForPointer(pointer, byType, changes) {
        ...
        switch (element?.type) {
            case 'XMLElement': {
                ...
                edits.push(...this.handleXmlElementChanges(elementChanges, element, pointer, childIndentLevel, changes));
                break;
            }
            case 'XMLAttribute': {
    ...
    handleXmlElementChanges(elementChanges, element, pointer, childIndentLevel, changes) {
        const edits = [];
    ...
    prepareXmlElementMoveChange(moveChange, changes) {
        const textEdits = [];

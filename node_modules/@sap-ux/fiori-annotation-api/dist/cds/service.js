 ...
 */
async function getCDSService(projectRoot, serviceName, fileCache, clearCache = false) {
    const files = await (0, ux_cds_compiler_facade_1.getCdsFiles)(projectRoot, fileCache, clearCache);

 ...
 */
export declare function createInsertTargetChange(pointer: JsonPointer, target: AnnotationFileTarget, index?: number, complexTypePathSegments?: string[]): InsertTarget;

        ...
        return this.adapter.getExternalServices().map(({ compiledService, metadataService, uri, localFileUri }) => {
            ...
            try {
                ...
                const rawMetadata = {
                    ...
                    identification: 'metadataFile',
                    schema: (0, avt_1.convertMetadataToAvtSchema)(ms),
                    references: []
                };

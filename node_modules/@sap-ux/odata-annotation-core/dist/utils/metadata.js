...
function isPathPointingToActionKindElement(metadata, path) {
    ...
    const actionKinds = new Set([odata_annotation_core_types_1.ACTION_KIND, odata_annotation_core_types_1.FUNCTION_KIND, odata_annotation_core_types_1.ACTION_IMPORT_KIND, odata_annotation_core_types_1.FUNCTION_IMPORT_KIND]);

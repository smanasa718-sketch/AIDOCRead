...
exports.default = {
    ...
    'com.sap.vocabularies.Auditing.v1': {
        ...
        'DefaultAuditorScopes': {
            ...
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'List of scopes which have by default auditing access for entity sets in the annotated service. Annotating @Auditing.AuditorScopes to an entity set overrides this default.'
        },
        'AuditorScopes': {
            '$Kind': 'Term',
            '$Collection': true,
            '$AppliesTo': ['EntitySet'],
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'List of scopes which have auditing access for the annotated entity set. Auditing access could for example mean accessing blocked or archived entities.'
        }
    }
};
//# sourceMappingURL=com.sap.vocabularies.Auditing.v1.js.map
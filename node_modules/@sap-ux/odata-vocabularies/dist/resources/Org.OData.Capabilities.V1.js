    ...
    'Org.OData.Capabilities.V1': {
        ...
        'BatchSupportType': {
            ...
            'ContinueOnErrorSupported': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'When the client specifies the `continue-on-error` preference, the service applies it\n            by processing all requests according to their dependencies, regardless of the format for the $batch request.'
            },
        ...
        'FilterExpressionType': {
            ...
            '@Org.OData.Validation.V1.AllowedValues': [
                ...
                },
                {
                    ...
                    '@Org.OData.Core.V1.Description': 'String property can be used as first operand in one or more `startswith`, `endswith`, and `contains` clauses, combined by `or`'
                },
                {
        ...
        'ExpandByKeyRestrictionsType': {
            ...
            'NonExpandableProperties': {
                '$Collection': true,
                '$Type': 'Edm.NavigationPropertyPath',
                '@Org.OData.Core.V1.Description': 'These properties cannot be used in expand expressions when accessing by key'
            },
            'NonExpandableStreamProperties': {
                '$Collection': true,
                '$Type': 'Edm.PropertyPath',
                '@Org.OData.Core.V1.Description': 'These stream properties cannot be used in expand expressions when accessing by key'
            }
        },
        'SearchRestrictions': {
            '$Kind': 'Term',

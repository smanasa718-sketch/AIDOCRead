...
export type SapVocabularyNamespace = 'com.sap.vocabularies.Analytics.v1' | 'com.sap.vocabularies.Auditing.v1' | 'com.sap.vocabularies.CDS.v1' | 'com.sap.vocabularies.CodeList.v1' | 'com.sap.vocabularies.Common.v1' | 'com.sap.vocabularies.Communication.v1' | 'com.sap.vocabularies.DataIntegration.v1' | 'com.sap.vocabularies.DirectEdit.v1' | 'com.sap.vocabularies.Graph.v1' | 'com.sap.vocabularies.Hierarchy.v1' | 'com.sap.vocabularies.ODM.v1' | 'com.sap.vocabularies.PDF.v1' | 'com.sap.vocabularies.PersonalData.v1' | 'com.sap.vocabularies.Session.v1' | 'com.sap.vocabularies.UI.v1' | 'com.sap.vocabularies.HTML5.v1';
export type SapVocabularyAlias = 'Analytics' | 'Auditing' | 'CDS' | 'CodeList' | 'Common' | 'Communication' | 'DataIntegration' | 'DirectEdit' | 'Graph' | 'Hierarchy' | 'ODM' | 'PDF' | 'PersonalData' | 'Session' | 'UI' | 'HTML5';
export type OasisVocabularyNamespace = 'Org.OData.Aggregation.V1' | 'Org.OData.Authorization.V1' | 'Org.OData.Capabilities.V1' | 'Org.OData.Core.V1' | 'Org.OData.Measures.V1' | 'Org.OData.Repeatability.V1' | 'Org.OData.Temporal.V1' | 'Org.OData.Validation.V1' | 'Org.OData.JSON.V1';
export type OasisVocabularyAlias = 'Aggregation' | 'Auth' | 'Capabilities' | 'Core' | 'Measures' | 'Repeatability' | 'Temporal' | 'Validation' | 'JSON';
...
export declare const ALIAS_TO_NAMESPACE: Map<VocabularyAlias, VocabularyNamespace>;
declare const vocabularies: Record<string, CSDL>;

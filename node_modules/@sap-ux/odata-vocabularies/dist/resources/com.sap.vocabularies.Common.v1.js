    ...
    'com.sap.vocabularies.Common.v1': {
        ...
        'ValueListType': {
            ...
            'RelativeCollectionPath': {
                '$Type': 'Edm.NavigationPropertyPath',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Navigation property path of an OData collection with possible values, relative to the annotation target'
            },
            'CollectionRoot': {
                '$Nullable': true,
                ...
                '@Org.OData.Core.V1.LongDescription': '`CollectionRoot` must not be specified unless `CollectionPath` is provided.'
            },
            ...
            '@Org.OData.Core.V1.Description': 'Exactly one of `CollectionPath` and `RelativeCollectionPath` must be provided.'
        },
        'FetchValuesType': {
            '$Kind': 'TypeDefinition',
            '$UnderlyingType': 'Edm.Byte',
        ...
        'SideEffectsType': {
            ...
            'SourceEntities': {
                ...
                '$Type': 'Edm.NavigationPropertyPath',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Changes to one or more of these entities may affect the targets. An null value means the annotation target.'
            },
            'SourceEvents': {
                '$Collection': true,
                '@com.sap.vocabularies.Common.v1.Experimental': true,
            ...
            'TargetEntities': {
                ...
                '$Type': 'Edm.NavigationPropertyPath',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'These entities will be affected if the value of one of the sources changes. All affected entities need to be explicitly listed. A null value means the annotation target.'
            },
            'TriggerAction': {
                '$Type': 'com.sap.vocabularies.Common.v1.QualifiedName',
                '$Nullable': true,
        ...
        'ReferentialConstraint': {
            ...
            '$AppliesTo': ['NavigationProperty'],
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': '[Referential constraints](https://oasis-tcs.github.io/odata-specs/odata-csdl-xml/odata-csdl-xml.html#ReferentialConstraint) without nullability requirement'
        },
        'ReferentialConstraintType': {
            '$Kind': 'ComplexType',
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'A record that behaves like the standard referential constraint on the navigation property targeted by a [`ReferentialConstraint`](#ReferentialConstraint) annotation,\n          but the nullability requirement for the dependent property is lifted.\n          It asserts that the principal property _of an existing related entity_\n          must have the same value as the dependent property.',
            'Property': {
                '$Type': 'Edm.PropertyPath',
                '@Org.OData.Core.V1.Description': 'The path to the property is evaluated relative to the type containing the navigation property'
            },
            'ReferencedProperty': {
                '$Type': 'Edm.PropertyPath',
                '@Org.OData.Core.V1.Description': 'The path to the referenced property MUST start with a segment containing the navigation property'
            }
        }
    }
};

...
exports.default = {
    ...
    'com.sap.vocabularies.UI.v1': {
        ...
        'OperationParameterFacets': {
            ...
            '@Org.OData.Core.V1.Description': 'Facets that reference UI.FieldGroup annotations to group action or function parameters'
        },
        'Facet': {
            '$Kind': 'ComplexType',
            '$Abstract': true,
        ...
        'PresentationVariantType': {
            ...
            'RecursiveHierarchyQualifier': {
                ...
                '$Nullable': true,
                '@com.sap.vocabularies.Common.v1.Experimental': true,
                '@Org.OData.Core.V1.Description': 'Qualifier of the recursive hierarchy that should be applied to the Visualization'
            },
            'RequestAtLeast': {
                '$Collection': true,
                '$Type': 'Edm.PropertyPath',
        ...
        'DateTimeStyle': {
            ...
            '$Nullable': true,
            '$AppliesTo': ['Property', 'Parameter'],
            '@Org.OData.Core.V1.Description': 'The temporal value represented by the annotated property or parameter shall be shown on the UI in the given style',
            '@Org.OData.Core.V1.LongDescription': 'Requires type `Edm.Date`, `Edm.TimeOfDay`, or `Edm.DateTimeOffset`.\n          If this annotation is absent or null or an empty string, temporal values are shown in a default style.',
            '@Org.OData.Validation.V1.AllowedValues': [
                ...
                {
                    'Value': 'full',
                    '@Org.OData.Core.V1.Description': 'Thursday, July 25, 2024 at 1:11:51 PM Central European Summer Time'
                }
            ]
        },
        'Note': {
        ...
        'IsAIOperation': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'This term allows making end-users aware that the annotated operation uses AI functionality to process the selected application data.'
        },
        'CreateHidden': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Core.V1.Tag',
        ...
        'DataFieldForActionGroup': {
            ...
            'ID': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Identifier of an action group. ID should be stable, as long as the perceived semantics of the action group is unchanged.',
                '@Org.OData.Core.V1.LongDescription': 'The ID should be unique among all action groups used in all data fields of one entity type / set.'
            },
            'Actions': {
                '$Collection': true,
        ...
        'PropertyRecommendationType': {
            ...
            'RecommendedFieldValue': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'In informal specializations of this base type, this property is specialized to the primitive type of the entity type property.\n            If the recommendation has a description, this property has a [`Common.Text`](Common.md#Text) annotation\n            that evaluates to the `RecommendedFieldDescription` property.',
            ...
            'RecommendedFieldDescription': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'In informal specializations of this base type, this property is specialized to the string type of the text property corresponding to the entity type property.\n            It is omitted from informal specializations for recommendations without description.'
            },

...
exports.default = {
    ...
    'Org.OData.Core.V1': {
        ...
        'Link': {
            '$Kind': 'ComplexType',
            '@Org.OData.Core.V1.Description': 'The Link type is inspired by the `atom:link` element, see [RFC4287](https://tools.ietf.org/html/rfc4287#section-4.2.7), and the `Link` HTTP header, see [RFC5988](https://tools.ietf.org/html/rfc5988)',
            'rel': {
        ...
        'IsDelta': {
            ...
            '@Org.OData.Core.V1.Description': 'The annotated Action or Function Parameter or Return Type is represented as a Delta payload',
            '@Org.OData.Core.V1.LongDescription': 'The parameter or result is represented as a delta payload, which may include deleted entries as well as changes to related \n          entities and relationships, according to the format-specific delta representation.'
        }
    }
};

...
exports.default = {
    ...
    'com.sap.vocabularies.Analytics.v1': {
        ...
        'MultiLevelExpand': [
            {
                ...
                '$Parameter': [
                    ...
                    },
                    {
                        ...
                        '$Type': 'Edm.Boolean',
                        '@Org.OData.Core.V1.Description': 'Whether to duplicate the group headers so that they appear before and after their descendants',
                        '@Org.OData.Core.V1.LongDescription': 'The entry before has [DrillState](Hierarchy.md#HierarchyType) `expanded`,\n            the entry after has DrillState `subtotal`.',
                        '@Org.OData.Core.V1.OptionalParameter': {
                            'DefaultValue': 'false'
                        }
                    }
                ...
                '$ReturnType': {
                    '$Collection': true,
                    '$Type': 'Edm.EntityType',
                    '@Org.OData.Core.V1.Description': 'Output set including the instance annotation [`LevelInformation`](#LevelInformation)'
                }
            }
        ],
        'MultiLevelExpandLevel': {
            '$Kind': 'ComplexType',
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'Property names constituting a level in an [unnamed leveled hierarchy](#MultiLevelExpand)',
            '@Org.OData.Core.V1.LongDescription': '`DimensionProperties` must be used to identify entries in [`ExpandEntries/Entry`](#MultiLevelExpandEntry),\n          otherwise they have the same effect as `AdditionalProperties`.',
            'DimensionProperties': {
                '$Collection': true,
                '@Org.OData.Core.V1.Description': 'A non-empty list of property names that define a combination of dimension values'
            },
            'AdditionalProperties': {
                '$Collection': true,
                '@Org.OData.Core.V1.Description': 'A possibly empty list of names of additional properties of the dimensions that occur in `DimensionProperties`'
            }
        },
        ...
        'MultiLevelExpandEntry': {
            '$Kind': 'ComplexType',
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'Expansion state of an entry in an [unnamed leveled hierarchy](#MultiLevelExpand)',
            'Entry': {
                '$Collection': true,
                '@Org.OData.Core.V1.Description': 'An entry on a given [level](#MultiLevelExpandLevel) is identified by a list of values for the `DimensionProperties` that constitute all levels up to and including the given one',
        ...
        'LevelInformation': {
            ...
            '$AppliesTo': ['EntityType'],
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'Information about grouping levels in the result set of a request including the [`MultiLevelExpand`](#MultiLevelExpand) transformation'
        }
    }
};

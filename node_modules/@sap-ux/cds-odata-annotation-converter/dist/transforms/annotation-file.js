...
const toAnnotationFile = (fileUri, vocabularyService, cdsAnnotationFile, metadataCollector, position, propagationMap, mergePropagatedAnnotations = false) => {
 ...
 */
function checkGhostTarget(returnValue, propagationMap, mergePropagatedAnnotations) {
    if (propagationMap) {

...
const rule = (0, rule_factory_1.createFioriRule)({
    ...
    meta: {
        ...
        messages: {
            [diagnostics_1.TABLE_PERSONALIZATION]: 'Table personalization should be enabled. Currently every table personalization setting is disabled.',
            ...
            [TABLE_PERSONALIZATION_GROUP]: 'Table data grouping should be enabled for analytical and responsive type tables.',
 ...
 */
function checkPersonalizationValue(table, page, parsedApp) {
    const problems = [];

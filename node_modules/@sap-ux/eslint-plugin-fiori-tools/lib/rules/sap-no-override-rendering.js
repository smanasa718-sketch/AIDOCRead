    ...
    create(context) {
        ...
        function checkIfNotAllowedMethod(property) {
            if (property !== undefined &&
                ((0, helpers_1.contains)(CHECKED_METHODS, property) || property.startsWith('get') || property.startsWith('set'))) {
                return true;
            }
            return false;
        }
        ...
        function checkAssignmentAgainstOverride(node) {
            if (node.left.type === 'MemberExpression' && node.right.type === 'FunctionExpression') {
                const memberExpression = node.left, objectProperty = memberExpression.property.name;
                ...
                if (checkIfNotAllowedMethod(objectProperty)) {
                    ...
                    if ((0, helpers_1.contains)(ui5ObjectsToCheck, objectNameToCheck)) {
                        context.report({
                            node: node,
...
//# sourceMappingURL=sap-no-override-rendering.js.map
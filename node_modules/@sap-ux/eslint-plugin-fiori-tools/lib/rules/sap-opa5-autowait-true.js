 ...
 * @param node
 */
function isOpa5ExtendConfigCall(node) {
 ...
 * @param propsList
 */
function findAutoWaitProperty(propsList) {
...
const rule = {
    ...
    create(context) {
         ...
         * @param node
         */
        function handleOpa5ExtendConfig(node) {
...
//# sourceMappingURL=sap-opa5-autowait-true.js.map
 ...
 */
function checkInvalidMode(statePreservationMode, validValues, hasFCL, linkedApp, app) {
    if (!validValues.includes(statePreservationMode)) {
        return {
            type: diagnostics_1.STATE_PRESERVATION_MODE,
 ...
 */
function checkModeRecommendation(statePreservationMode, hasFCL, linkedApp, app) {
...
const rule = (0, rule_factory_1.createFioriRule)({
    ruleId: diagnostics_1.STATE_PRESERVATION_MODE,
    meta: {
        type: 'suggestion',
        docs: {
            recommended: true,
        ...
        messages: {
            ...
            recommendPersistenceForFCL: 'Consider using default. For applications using Flexible Column Layout (FCL), default is "persistence" mode.',
            recommendDiscoveryForNonFCL: 'Consider using default. For applications not using Flexible Column Layout, default is "discovery" mode.'
        },
        fixable: 'code'
    },
    check(context) {
...
//# sourceMappingURL=sap-state-preservation-mode.js.map